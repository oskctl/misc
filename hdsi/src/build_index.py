...
def build_us(use_credit_gap: bool = True) -> pd.DataFrame:
...
def build_uk(use_credit_gap: bool = True) -> pd.DataFrame:
...
def main(use_credit_gap: bool = True) -> None:
...
if __name__ == "__main__":
    args = _parse_args()
    main(use_credit_gap=not args.level)
